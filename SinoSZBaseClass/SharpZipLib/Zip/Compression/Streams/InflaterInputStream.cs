...
using SinoSZBaseClass.SharpZipLib.Zip.Compression;
using SinoSZBaseClass.SharpZipLib.Checksums;

namespace SinoSZBaseClass.SharpZipLib.Zip.Compression.Streams 
{
	...
	public class InflaterInputStream : Stream
	{
		...
		public InflaterInputStream(Stream baseInputStream, Inflater inf, int size)
		{
			...
			//	这里总是报告异常, 虽然用try/catch处理了，但这样效率会较低, 因此用 if (baseInputStream.CanSeek) 代替
			//	是否可靠还需要验证, 黄晓东, 2004.3.20
