...
namespace SinoSZJS.CS.BizMetaDataManager.DAL
{
    public class OraMetaDataQueryFactroy : IMetaDataQueryFactroy
    {
        ...
        private void AddTaskRecord(string _taskid, string _taskName, string _taskType, MDQuery_Request _queryRequest, SqlConnection cn)
        {
            ...
            //_cmd.Parameters.Add(new SqlParameter(":QUERYCONTEXT", OracleDbType.Blob, blob.Length, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Current, blob));
        ...
        private void WriteQueryLogBySystem(string _sqlStr, int _userTime)
        {
            ...
            SqlParameter[] _param = { 
                                ...
                                new SqlParameter(":YHID", OracleDbType.Decimal) 
                                };
        ...
        public List<MDSearch_Column> GetSearchResultColumn(string _searchText, int _searchType, string _searchConceptGroup, string _queryModelName)
        {
            ...
            SqlParameter[] _param = { new SqlParameter(":NAMESPACE", SqlDbType.NVarChar),
        ...
        public List<MDQuery_Task> GetQueryTaskList()
        {
            ...
            SqlParameter[] _param = {
                                new SqlParameter(":REQUESTUSER",OracleDbType.Decimal)
        ...
        private MDQuery_Request GetQueryTaskRequestContext(string _taskID, ref string TaskType)
        {
            ...
            using (SqlConnection cn = SqlHelper.OpenConnection())
            {
                ...
                using (SqlDataReader mySqlDataReader = _cmd.ExecuteReader())
                {
                    ...
                    OracleBlob myOracleClob =null ;//mySqlDataReader.GetOracleBlob(0);
                    myOracleClob.Position = 0;
        ...
        public DataTable GetSaveQueryList(string QueryModelName)
        {
            ...
            SqlParameter[] _param = {
                                new SqlParameter(":YHID",OracleDbType.Decimal),
                                new SqlParameter(":DWID",OracleDbType.Decimal),
                                new SqlParameter(":VIEWNAME",SqlDbType.NVarChar)
                        };
            _param[0].Value = decimal.Parse(SinoUserCtx.CurUser.UserID);
        ...
        {
            SqlParameter[] _param = {
                                new SqlParameter(":TASKID",SqlDbType.NVarChar)
        ...
        {
            SqlParameter[] _param = {
                                new SqlParameter(":REQUESTTIME",OracleDbType.Date),
				new SqlParameter(":ID",SqlDbType.NVarChar)
                        };
