...
using System.Data;
using SinoSZBaseClass.Notify;
using SinoSZBaseClass.SystemInterface;
using SinoSZBaseClass.OrganizeExt;
using SinoSZBaseClass.TaskInfo;

namespace SinoSZBaseClass.UserLog
{
        /// <summary>
        /// 用户日志接口
        /// </summary>
