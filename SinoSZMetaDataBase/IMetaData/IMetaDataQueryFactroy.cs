...
using SinoSZMetaDataBase.DataCheck;
using SinoSZMetaDataBase.InputModel;
using SinoSZMetaDataBase.PAnalize;
using SinoSZMetaDataBase.GuideLineParamSetting;
using SinoSZMetaDataBase.DataCompare;

namespace SinoSZMetaDataBase.IMetaData
{
        public interface IMetaDataQueryFactroy
        {
                ...
                /// <param name="WHXH"></param>
                /// <returns></returns>
                bool SaveDataCheckResult(string CurrentJLID, string CurrentLevel, string CurrentID, string _shjg, string _shr, string _xgyj, string WHXH);
