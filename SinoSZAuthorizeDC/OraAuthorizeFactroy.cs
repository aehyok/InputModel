...
namespace SinoSZAuthorizeDC
{
    ...
    public class OraAuthorizeFactroy : IAuthorize
    {
        ...
        {
            C_SignOnBase _SignOnControler = new C_SignOnBase();
            if (CheckPassword(uname, old_pass,_type))
            {
                ...
                return (_SignOnControler.ChangePassword(uname, old_pass, new_pass,_type) == 1);
            }
            else
            {
                return false;
        ...
        public bool CheckPassword(string _uname, string old_pass,string _type)
        {
            ...
            return _SignOnControler.Check(_uname, old_pass,_type);
